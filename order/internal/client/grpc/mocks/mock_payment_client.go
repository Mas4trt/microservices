...
func (_m *PaymentClient) PayOrder(ctx context.Context, userUuid string, orderUuid string, paymentMethod model.PaymentMethod) (string, error) {
...
func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, userUuid string, orderUuid string, paymentMethod model.PaymentMethod)) *PaymentClient_PayOrder_Call {
