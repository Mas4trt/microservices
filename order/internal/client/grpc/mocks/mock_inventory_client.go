...
func (_m *InventoryClient) ListParts(ctx context.Context, filter model.PartsFilter) ([]model.PricedPart, error) {
	...
	var r0 []model.PricedPart
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.PartsFilter) ([]model.PricedPart, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.PartsFilter) []model.PricedPart); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.PricedPart)
		}
	}
...
func (_c *InventoryClient_ListParts_Call) Return(_a0 []model.PricedPart, _a1 error) *InventoryClient_ListParts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *InventoryClient_ListParts_Call) RunAndReturn(run func(context.Context, model.PartsFilter) ([]model.PricedPart, error)) *InventoryClient_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
