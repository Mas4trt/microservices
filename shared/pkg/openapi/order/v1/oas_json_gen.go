...
// Encode encodes PayOrderBadGateway as json.
func (s *PayOrderBadGateway) Encode(e *jx.Encoder) {
	unwrapped := (*GenericError)(s)

	unwrapped.Encode(e)
}

// Decode decodes PayOrderBadGateway from json.
func (s *PayOrderBadGateway) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PayOrderBadGateway to nil")
	}
	var unwrapped GenericError
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = PayOrderBadGateway(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *PayOrderBadGateway) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PayOrderBadGateway) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (s *ValidationError) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "violations":
			if err := func() error {
				s.Violations = make([]ValidationErrorViolationsItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem ValidationErrorViolationsItem
...
// Encode implements json.Marshaler.
func (s *ValidationErrorViolationsItem) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ValidationErrorViolationsItem) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("field")
		e.Str(s.Field)
	}
...
var jsonFieldsNameOfValidationErrorViolationsItem = [2]string{
	0: "field",
	1: "message",
}

// Decode decodes ValidationErrorViolationsItem from json.
func (s *ValidationErrorViolationsItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ValidationErrorViolationsItem to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ValidationErrorViolationsItem")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfValidationErrorViolationsItem) {
					name = jsonFieldsNameOfValidationErrorViolationsItem[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ValidationErrorViolationsItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ValidationErrorViolationsItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
